...
export const SKILL_CATALOG_SEED = [
  ...
  },
  {
    ...
    aliases: ['google cloud', 'google-cloud', 'google-cloud-platform', 'gcloud'],
    sortOrder: 101,
  },
  {
  ...
  },
  {
    ...
    subcategory: 'Cloud Providers',
    skillType: 'TECHNOLOGY',
    description: 'Web infrastructure and security company providing CDN and edge computing',
  ...
  },
  {
    ...
    subcategory: 'Cloud Providers',
    skillType: 'TECHNOLOGY',
    description: 'Google-backed application development platform',
    aliases: ['firebase-platform'],
    sortOrder: 106,
  },
  ...
  {
    canonicalName: 'AWS API Gateway',
    slug: 'aws-api-gateway',
    category: 'CLOUD',
    subcategory: 'AWS Services',
    skillType: 'TECHNOLOGY',
    description: 'Managed API Gateway service',
    aliases: ['api-gateway', 'aws-api-gw'],
    sortOrder: 118,
  },
  {
  ...
  },
  {
    ...
    aliases: ['sns', 'amazon-sns'],
    sortOrder: 120,
  },
  {
    canonicalName: 'AWS EventBridge',
  ...
  {
    canonicalName: 'AWS CloudFormation',
    slug: 'aws-cloudformation',
    category: 'CLOUD',
    subcategory: 'AWS Services',
    skillType: 'TECHNOLOGY',
    description: 'Infrastructure as Code service',
    aliases: ['cloudformation', 'aws-cfn'],
    sortOrder: 123,
  },
  {
    canonicalName: 'AWS CloudWatch',
    slug: 'aws-cloudwatch',
    category: 'CLOUD',
    subcategory: 'AWS Services',
    skillType: 'TECHNOLOGY',
  ...
  // GCP Services
  {
    canonicalName: 'Google Compute Engine',
    slug: 'gcp-compute-engine',
    category: 'CLOUD',
    subcategory: 'GCP Services',
    skillType: 'TECHNOLOGY',
    description: 'GCP virtual machine service',
    aliases: ['compute-engine'],
    sortOrder: 130,
  },
  {
    canonicalName: 'Google Cloud Run',
    slug: 'gcp-cloud-run',
    category: 'CLOUD',
    subcategory: 'GCP Services',
    skillType: 'TECHNOLOGY',
  ...
  {
    canonicalName: 'Google GKE',
    slug: 'gcp-gke',
    category: 'CLOUD',
    subcategory: 'GCP Services',
    skillType: 'TECHNOLOGY',
    description: 'Google Kubernetes Engine',
    aliases: ['gke', 'google-kubernetes-engine'],
    sortOrder: 132,
  },
  {
  ...
  {
    canonicalName: 'Azure AKS',
    slug: 'azure-aks',
    category: 'CLOUD',
    subcategory: 'Azure Services',
    skillType: 'TECHNOLOGY',
    description: 'Azure Kubernetes Service',
    aliases: ['aks', 'azure-kubernetes'],
    sortOrder: 141,
  },
  {
  ...
  },
  {
    ...
    subcategory: 'Azure Services',
    skillType: 'TECHNOLOGY',
    description: 'DevOps toolchain for planning, CI/CD, and repositories',
    aliases: ['azure-devops-services'],
    sortOrder: 144,
  },
  ...
  // =========================================================================
  {
    ...
    skillType: 'TECHNOLOGY',
    description: 'CI/CD platform integrated into GitHub',
    aliases: ['gh-actions', 'gha', 'github-workflows'],
    sortOrder: 300,
  },
  {
    canonicalName: 'GitLab CI/CD',
    slug: 'gitlab-ci',
    category: 'CICD',
    subcategory: 'CI/CD Platforms',
    skillType: 'TECHNOLOGY',
    description: 'GitLab integrated CI/CD system',
    aliases: ['gitlab-ci-cd', 'gitlab-pipelines'],
    sortOrder: 301,
  },
  {
  ...
  },
  {
    ...
    subcategory: 'CI/CD Platforms',
    skillType: 'TECHNOLOGY',
    description: 'Scalable CI/CD platform',
    aliases: ['buildkite-ci'],
    sortOrder: 304,
  },
  {
  ...
  },
  {
    ...
    subcategory: 'Relational Databases',
    skillType: 'TECHNOLOGY',
    description: 'Community-developed relational database fork',
    aliases: ['maria'],
    sortOrder: 402,
  },
  {
  ...
  },
  {
    ...
    subcategory: 'Vector Databases',
    skillType: 'TECHNOLOGY',
    description: 'AI-native vector search engine',
    aliases: ['weaviate-db'],
    sortOrder: 451,
  },
  {
    canonicalName: 'Milvus',
    slug: 'milvus',
    category: 'DATABASES',
    subcategory: 'Vector Databases',
    skillType: 'TECHNOLOGY',
  ...
  },
  {
    ...
    aliases: ['nats-server', 'nats-jetstream'],
    sortOrder: 511,
  },
  {
  ...
  {
    canonicalName: 'Reverse Proxy',
    slug: 'reverse-proxy',
    category: 'NETWORKING',
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Server that sits between clients and backend servers',
    aliases: ['reverse-proxy-pattern'],
    sortOrder: 620,
  },
  {
  ...
  },
  {
    ...
    subcategory: 'Core',
    skillType: 'CONCEPT',
    description: 'Domain Name System for internet name resolution',
    aliases: ['domain-name-system'],
    sortOrder: 640,
  },
  {
    canonicalName: 'TCP/IP',
    slug: 'tcp-ip',
    category: 'NETWORKING',
    subcategory: 'Core',
    skillType: 'CONCEPT',
    description: 'Fundamental networking protocol suite',
    aliases: ['tcpip'],
    sortOrder: 641,
  },
  {
    canonicalName: 'HTTP/2',
    slug: 'http2',
    category: 'NETWORKING',
    subcategory: 'Protocols',
    skillType: 'TECHNOLOGY',
    description: 'HTTP protocol version 2 with multiplexing',
    aliases: ['h2'],
    sortOrder: 650,
  },
  {
    canonicalName: 'HTTP/3',
    slug: 'http3',
    category: 'NETWORKING',
    subcategory: 'Protocols',
    skillType: 'TECHNOLOGY',
    description: 'HTTP protocol version 3 over QUIC',
    aliases: ['h3', 'quic'],
    sortOrder: 651,
  },
  {
    canonicalName: 'TLS/SSL',
    slug: 'tls-ssl',
    category: 'NETWORKING',
    subcategory: 'Security',
    skillType: 'TECHNOLOGY',
    description: 'Transport Layer Security and Secure Sockets Layer',
    aliases: ['ssl', 'tls', 'ssl-tls'],
    sortOrder: 660,
  },
  {
    canonicalName: 'WebSocket',
    slug: 'websocket',
    category: 'NETWORKING',
    subcategory: 'Protocols',
    skillType: 'TECHNOLOGY',
    description: 'Full-duplex communication protocol over TCP',
  ...
  },
  {
    ...
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Entry point for API requests in microservices',
    aliases: ['api-gateway-pattern'],
    sortOrder: 690,
  },
  {
    canonicalName: 'Service Discovery',
    slug: 'service-discovery',
    category: 'NETWORKING',
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Automatic detection of services in a network',
  ...
  {
    canonicalName: 'ELK Stack',
    slug: 'elk-stack',
    category: 'OBSERVABILITY',
    subcategory: 'Logging',
    skillType: 'TECHNOLOGY',
    description: 'Elasticsearch, Logstash, and Kibana stack',
    aliases: ['elastic-stack'],
    sortOrder: 770,
  },

  // Observability concepts
  {
    canonicalName: 'Distributed Tracing',
    slug: 'distributed-tracing',
    category: 'OBSERVABILITY',
    subcategory: 'Concepts',
    skillType: 'CONCEPT',
    description: 'Tracking requests across microservice boundaries',
    aliases: [],
    sortOrder: 780,
  },
  {
    canonicalName: 'SLI/SLO/SLA',
    slug: 'sli-slo-sla',
    category: 'OBSERVABILITY',
    subcategory: 'Concepts',
    skillType: 'CONCEPT',
    description: 'Service Level Indicators, Objectives, and Agreements',
    aliases: ['service-level-objectives'],
    sortOrder: 781,
  },
  {
    ...
    skillType: 'PRACTICE',
    description: 'Structured approach to managing production incidents',
    aliases: ['on-call', 'incident-management'],
    sortOrder: 782,
  },
  {
    canonicalName: 'Performance Optimization',
    slug: 'performance-optimization',
    category: 'OBSERVABILITY',
    subcategory: 'Concepts',
    skillType: 'PRACTICE',
    description: 'Systematic improvement of application performance',
  ...
  // =========================================================================
  {
    ...
    aliases: ['oauth2', 'oauth-2-0', 'oauth2.1', 'pkce'],
    sortOrder: 800,
  },
  {
    canonicalName: 'OpenID Connect',
    slug: 'openid-connect',
    category: 'SECURITY',
    subcategory: 'Auth',
    skillType: 'TECHNOLOGY',
  ...
  },
  {
    ...
    skillType: 'TECHNOLOGY',
    description: 'XML-based federated identity standard',
    aliases: ['saml-2.0'],
    sortOrder: 810,
  },
  {
    ...
    subcategory: 'Federation',
    skillType: 'CONCEPT',
    description: 'Single Sign-On authentication scheme',
  ...
  },
  {
    ...
    subcategory: 'Tokens',
    skillType: 'TECHNOLOGY',
    description: 'JSON Web Tokens for compact claims representation',
  ...
  },
  {
    ...
    aliases: ['relationship-based-access-control'],
    sortOrder: 852,
  },
  {
    ...
    subcategory: 'Practices',
    skillType: 'PRACTICE',
    description: 'Secure handling of credentials and secrets',
  ...
  },
  {
    ...
    skillType: 'CONCEPT',
    description: 'Security model requiring strict verification',
    aliases: ['zero-trust-architecture'],
    sortOrder: 870,
  },
  {
    canonicalName: 'Application Security',
    slug: 'application-security',
    category: 'SECURITY',
    subcategory: 'Practices',
    skillType: 'PRACTICE',
    description: 'Securing software applications against threats',
    aliases: ['appsec'],
    sortOrder: 880,
  },
  ...
  // =========================================================================
  {
    canonicalName: 'REST API Design',
    slug: 'rest-api',
    category: 'ARCHITECTURE',
    subcategory: 'API Design',
    skillType: 'CONCEPT',
    description: 'RESTful API architectural style',
  ...
  },
  {
    ...
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Architectural style structuring apps as service collections',
    aliases: ['microservice-architecture'],
    sortOrder: 910,
  },
  {
    canonicalName: 'Modular Monolith',
    slug: 'modular-monolith',
    category: 'ARCHITECTURE',
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Monolithic architecture with well-defined module boundaries',
    aliases: ['modular-monolithic'],
    sortOrder: 911,
  },
  {
    ...
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Architecture based on production and consumption of events',
    aliases: ['eda', 'event-driven'],
    sortOrder: 920,
  },
  {
    canonicalName: 'Serverless Architecture',
    slug: 'serverless',
    category: 'ARCHITECTURE',
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
  ...
  {
    canonicalName: 'Domain-Driven Design',
    slug: 'ddd',
    category: 'ARCHITECTURE',
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Software design approach focused on domain modeling',
  ...
  {
    canonicalName: 'Event Sourcing',
    slug: 'event-sourcing',
    category: 'ARCHITECTURE',
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Storing state changes as a sequence of events',
    aliases: ['event-store'],
    sortOrder: 932,
  },
  {
    ...
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'System design for maximum uptime',
    aliases: ['ha', 'fault-tolerant'],
    sortOrder: 940,
  },
  {
    ...
    subcategory: 'Concepts',
    skillType: 'CONCEPT',
    description: 'Ability to handle growing workload efficiently',
    aliases: ['horizontal-scaling', 'vertical-scaling'],
    sortOrder: 941,
  },
  {
    ...
    subcategory: 'Concepts',
    skillType: 'CONCEPT',
    description: 'Property ensuring repeated operations produce same result',
    aliases: ['idempotent'],
    sortOrder: 942,
  },
  {
  ...
  },
  {
    ...
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Software architecture serving multiple tenants',
  ...
  {
    canonicalName: 'End-to-End Testing',
    slug: 'e2e-testing',
    category: 'DEVELOPMENT',
    subcategory: 'Testing',
    skillType: 'PRACTICE',
  ...
  {
    canonicalName: 'Contract Testing',
  ...
  },
  {
    ...
    subcategory: 'Practices',
    skillType: 'PRACTICE',
    description: 'Development cycle: write test, implement, refactor',
    aliases: ['test-driven'],
    sortOrder: 1010,
  },
  {
    canonicalName: 'Load Testing',
    slug: 'load-testing',
    category: 'DEVELOPMENT',
    subcategory: 'Testing',
    skillType: 'PRACTICE',
    description: 'Testing system behavior under expected load',
    aliases: ['performance-testing'],
    sortOrder: 1020,
  },
  {
    canonicalName: 'Chaos Engineering',
    slug: 'chaos-engineering',
    category: 'DEVELOPMENT',
    subcategory: 'Practices',
    skillType: 'PRACTICE',
    description: 'Experimenting on systems to build resilience',
  ...
  // =========================================================================
  {
    ...
    subcategory: 'Core',
    skillType: 'PRACTICE',
    description: 'Using AI tools to enhance software development workflows',
    aliases: ['ai-coding', 'ai-native-development', 'agent-assisted-development'],
    sortOrder: 1100,
  },
  {
  ...
  {
    canonicalName: 'AI Code Review',
    slug: 'ai-code-review',
    category: 'AI_DEVELOPMENT',
    subcategory: 'Practices',
    skillType: 'PRACTICE',
    description: 'Using AI to review code quality and security',
    aliases: ['ai-review'],
    sortOrder: 1120,
  },
  {
    canonicalName: 'AI Test Generation',
    slug: 'ai-test-generation',
    category: 'AI_DEVELOPMENT',
    subcategory: 'Practices',
    skillType: 'PRACTICE',
    description: 'Using AI to generate test cases',
    aliases: ['ai-testing'],
    sortOrder: 1121,
  },
  ...
  {
    canonicalName: 'LLM APIs',
    slug: 'llm-apis',
    category: 'GENAI',
    subcategory: 'Integration',
    skillType: 'TECHNOLOGY',
    description: 'APIs for accessing large language models',
    aliases: ['openai-api', 'anthropic-api', 'gemini-api'],
    sortOrder: 1201,
  },
  {
  ...
  },
  {
    ...
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Retrieval-Augmented Generation for grounding LLMs',
    aliases: ['retrieval-augmented-generation'],
    sortOrder: 1220,
  },
  {
    canonicalName: 'Context Engineering',
    slug: 'context-engineering',
    category: 'GENAI',
    subcategory: 'Practices',
    skillType: 'PRACTICE',
    description: 'Designing context for optimal LLM performance',
  ...
  },
  {
    ...
    aliases: ['text-embeddings', 'vector-embeddings'],
    sortOrder: 1230,
  },
  {
    ...
    subcategory: 'Core',
    skillType: 'CONCEPT',
    description: 'Similarity search using vector embeddings',
    aliases: ['semantic-search'],
    sortOrder: 1231,
  },
  {
    canonicalName: 'Structured Outputs',
    slug: 'structured-outputs',
    category: 'GENAI',
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Getting LLMs to produce structured JSON responses',
    aliases: ['json-mode', 'function-calling'],
    sortOrder: 1240,
  },
  {
    canonicalName: 'LLM Evaluation',
    slug: 'llm-evaluation',
    category: 'GENAI',
    subcategory: 'Quality',
    skillType: 'PRACTICE',
    description: 'Measuring and improving LLM output quality',
    aliases: ['ai-evaluation'],
    sortOrder: 1250,
  },
  {
    canonicalName: 'AI Guardrails',
    slug: 'ai-guardrails',
    category: 'GENAI',
    subcategory: 'Safety',
    skillType: 'CONCEPT',
    description: 'Safety mechanisms for AI system outputs',
    aliases: ['ai-safety', 'content-filtering'],
    sortOrder: 1260,
  },
  {
    canonicalName: 'Fine-Tuning',
    slug: 'fine-tuning',
    category: 'GENAI',
    subcategory: 'Training',
    skillType: 'PRACTICE',
    description: 'Adapting pre-trained models for specific tasks',
    aliases: ['model-fine-tuning', 'lora'],
    sortOrder: 1270,
  },
  ...
  // =========================================================================
  {
    canonicalName: 'AI Agents',
    slug: 'ai-agents',
    category: 'AI_AGENTS',
    subcategory: 'Core',
    skillType: 'CONCEPT',
    description: 'Autonomous AI systems that use tools and make decisions',
    aliases: ['agentic-ai', 'ai-agent'],
    sortOrder: 1300,
  },
  {
    canonicalName: 'Agentic Workflows',
    slug: 'agentic-workflows',
    category: 'AI_AGENTS',
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Multi-step autonomous AI task execution patterns',
    aliases: ['agent-workflows'],
    sortOrder: 1310,
  },
  {
    canonicalName: 'Multi-Agent Systems',
    slug: 'multi-agent-systems',
    category: 'AI_AGENTS',
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Systems with multiple AI agents collaborating',
    aliases: ['multi-agent'],
    sortOrder: 1311,
  },
  {
    canonicalName: 'Agent Orchestration',
    slug: 'agent-orchestration',
    category: 'AI_AGENTS',
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'Coordinating multiple AI agents and tools',
  ...
  },
  {
    ...
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'State and context persistence for AI agents',
  ...
  },
  {
    ...
    subcategory: 'Patterns',
    skillType: 'CONCEPT',
    description: 'AI systems with human oversight and approval',
    aliases: ['hitl'],
    sortOrder: 1314,
  },
  {
  ...
  {
    canonicalName: 'Google ADK',
    slug: 'google-adk',
    category: 'AI_AGENTS',
    subcategory: 'Frameworks',
    skillType: 'TECHNOLOGY',
    description: 'Google Agent Development Kit',
    aliases: ['agent-dev-kit'],
    sortOrder: 1323,
  },
  {
    canonicalName: 'OpenAI Agents SDK',
    slug: 'openai-agents-sdk',
    category: 'AI_AGENTS',
    subcategory: 'Frameworks',
    skillType: 'TECHNOLOGY',
    description: 'OpenAI Agents SDK for building AI agents',
    aliases: ['openai-agent'],
    sortOrder: 1324,
  },
  {
    canonicalName: 'PydanticAI',
    slug: 'pydantic-ai',
    category: 'AI_AGENTS',
    subcategory: 'Frameworks',
    skillType: 'TECHNOLOGY',
    description: 'Agent framework using Pydantic for structured outputs',
    aliases: ['pydantic-ai-agent'],
    sortOrder: 1325,
  },
  ...
  // =========================================================================
  {
    ...
    subcategory: 'Core',
    skillType: 'TECHNOLOGY',
    description: 'Open standard for AI-tool connectivity',
    aliases: ['model-context-protocol', 'mcp-server', 'mcp-client'],
    sortOrder: 1400,
  },
  {
    canonicalName: 'Agent-to-Agent Protocol',
    slug: 'a2a',
    category: 'MCP',
  ...
  {
    canonicalName: 'Tool Interoperability',
    slug: 'tool-interoperability',
    category: 'MCP',
    subcategory: 'Concepts',
    skillType: 'CONCEPT',
    description: 'Standardized tool interfaces across AI systems',
    aliases: ['function-calling-standard'],
    sortOrder: 1420,
  },
  ...
  // =========================================================================
  {
    ...
    subcategory: 'Tools',
    skillType: 'TECHNOLOGY',
    description: 'LLM evaluation and red teaming framework',
    aliases: ['prompt-foo'],
    sortOrder: 1500,
  },
  {
  ...
  {
    canonicalName: 'AI Red Teaming',
    slug: 'ai-red-teaming',
    category: 'AI_QUALITY',
    subcategory: 'Practices',
    skillType: 'PRACTICE',
    description: 'Adversarial testing of AI systems',
    aliases: ['red-teaming'],
    sortOrder: 1520,
  },
  {
    canonicalName: 'Hallucination Detection',
    slug: 'hallucination-detection',
    category: 'AI_QUALITY',
    subcategory: 'Practices',
    skillType: 'PRACTICE',
    description: 'Identifying and mitigating LLM factual errors',
  ...
  // =========================================================================
  {
    ...
    skillType: 'CONCEPT',
    description: 'Deploying ML models for inference at scale',
    aliases: ['model-deployment'],
    sortOrder: 1600,
  },
  {
    canonicalName: 'ML Pipelines',
    slug: 'ml-pipelines',
    category: 'MLOPS',
    subcategory: 'Automation',
    skillType: 'CONCEPT',
    description: 'Automated ML workflow orchestration',
    aliases: ['ml-workflow'],
    sortOrder: 1601,
  },
  {
  ...
  {
    canonicalName: 'KServe',
    slug: 'kserve',
    category: 'MLOPS',
    subcategory: 'Serving',
    skillType: 'TECHNOLOGY',
    description: 'Model serving on Kubernetes',
    aliases: ['kfserving'],
    sortOrder: 1630,
  },
  ...
  // =========================================================================
  {
    canonicalName: 'Developer Experience',
    slug: 'developer-experience',
    category: 'DX',
    subcategory: 'Core',
    skillType: 'PRACTICE',
    description: 'Optimizing developer productivity and satisfaction',
    aliases: ['devex', 'dx'],
    sortOrder: 1700,
  },
  {
    ...
    subcategory: 'Platforms',
    skillType: 'CONCEPT',
    description: 'Self-service platform for developer workflows',
    aliases: ['internal-developer-platform'],
    sortOrder: 1710,
  },
  {
    canonicalName: 'Backstage',
    slug: 'backstage',
    category: 'DX',
    subcategory: 'Tools',
    skillType: 'TECHNOLOGY',
    description: 'Spotify open-source developer portal',
    aliases: ['backstage-io'],
    sortOrder: 1720,
  },
  {
    canonicalName: 'CLI Development',
    slug: 'cli-development',
    category: 'DX',
    subcategory: 'Skills',
    skillType: 'PRACTICE',
    description: 'Building effective command-line interfaces',
    aliases: ['cli-design'],
    sortOrder: 1730,
  },
  ...
  // =========================================================================
  {
    ...
    skillType: 'PRACTICE',
    description: 'Collaborative code review and merge workflow',
    aliases: ['pr', 'merge-requests'],
    sortOrder: 1800,
  },
  {
    canonicalName: 'Architecture Decision Records',
    slug: 'adr',
    category: 'PRACTICES',
    subcategory: 'Documentation',
    skillType: 'PRACTICE',
    description: 'Documents for recording architectural decisions',
