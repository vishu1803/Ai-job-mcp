...
const CONTEXT_PROMPTS = {
  ...
  profile: [
    { label: 'What is missing from my profile?', icon: 'alertCircle', prompt: 'What information is missing from my profile for employer screening?' },
  ...
  radar: [
    { label: 'How well do I match?', icon: 'radar', prompt: 'How well does my verified profile match this job description?' },
    ...
    { label: 'Prepare my application', icon: 'applications', prompt: 'Help me prepare my application and tailored answers for this role' },
  ],
  job: [
    { label: 'How well do I match?', icon: 'radar', prompt: 'How well does my verified profile match this job description?' },
  ...
  applications: [
    { label: 'What still needs attention?', icon: 'alertCircle', prompt: 'Which of my applications have missing fields, conflicts, or require action?' },
  ...
  application: [
    { label: 'What still needs attention?', icon: 'alertCircle', prompt: 'What items need my attention on this application before I can submit?' },
    { label: 'Review my application answers', icon: 'clipboard', prompt: 'Review my screening answers for this application' },
    { label: 'Help me prepare', icon: 'chat', prompt: 'Help me prepare for this role based on verified project evidence' },
  ],
  resumes: [
