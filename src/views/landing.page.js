  ...
  const content = `
    <div class="container">
      ...
      <section style="text-align:center; padding: 48px 0 64px;">
        <div style="display:inline-flex; align-items:center; gap:8px; background:rgba(99,102,241,0.12); border:1px solid rgba(99,102,241,0.3); border-radius:9999px; padding:6px 16px; margin-bottom:24px;">
          <span style="width:8px; height:8px; border-radius:50%; background:var(--accent-emerald);"></span>
          <span style="font-size:0.85rem; font-weight:600; color:var(--text-main); letter-spacing:0.02em;">Universal Remote MCP Server (2026-07-28 Spec)</span>
        </div>
        
        <h1 style="font-size: clamp(2.2rem, 5vw, 3.6rem); font-weight:800; line-height:1.15; letter-spacing:-0.03em; max-width:860px; margin:0 auto 20px; background: linear-gradient(180deg, #FFFFFF 30%, #9CA3AF 100%); -webkit-background-clip:text; -webkit-text-fill-color:transparent;">
          The Evidence-Backed AI Career Platform
        </h1>
        
        <p style="font-size:1.15rem; color:var(--text-muted); max-width:680px; margin:0 auto 36px; line-height:1.6;">
        ...
        <div style="display:flex; align-items:center; justify-content:center; gap:16px; flex-wrap:wrap;">
          ...
          <a href="/docs/mcp" class="btn btn-secondary" style="padding:12px 24px; font-size:1rem;">
        ...
        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap:24px;">
          <div class="card" style="border-left: 3px solid var(--accent-rose);">
            <div style="display:flex; align-items:center; gap:8px; margin-bottom:12px;">
              <span class="badge" style="background:rgba(244,63,94,0.15); color:#FB7185; border:1px solid rgba(244,63,94,0.3);">Legacy Resume Tools</span>
            </div>
            <h3 style="font-size:1.15rem; font-weight:600; margin-bottom:10px;">Unverified Hallucinations</h3>
      ...
      <section style="margin-bottom:64px;">
        <div style="text-align:center; margin-bottom:36px;">
          <h2 style="font-size:1.6rem; font-weight:700; letter-spacing:-0.02em;">Platform Capabilities</h2>
          <p style="color:var(--text-muted); font-size:0.95rem; margin-top:6px;">A complete engineering career intelligence and application suite.</p>
        </div>

        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap:24px;">
          <div class="card">
            <div style="width:40px; height:40px; border-radius:10px; background:rgba(99,102,241,0.15); display:flex; align-items:center; justify-content:center; margin-bottom:16px; color:var(--accent-indigo);">
            ...
            <h3 style="font-size:1.1rem; font-weight:600; margin-bottom:8px;">GitHub Ingestion</h3>
            <p style="color:var(--text-muted); font-size:0.875rem;">Deep AST analysis across JS/TS, Python, Go, Rust, Java, and Docker with automatic secret scrubbing.</p>
          </div>

          <div class="card">
            <div style="width:40px; height:40px; border-radius:10px; background:rgba(6,182,212,0.15); display:flex; align-items:center; justify-content:center; margin-bottom:16px; color:var(--accent-cyan);">
            ...
            <h3 style="font-size:1.1rem; font-weight:600; margin-bottom:8px;">Job-Fit & ATS Scoring</h3>
            <p style="color:var(--text-muted); font-size:0.875rem;">Deterministic 4-status evaluation comparing your code evidence graph against target job descriptions.</p>
          </div>

          <div class="card">
            <div style="width:40px; height:40px; border-radius:10px; background:rgba(16,185,129,0.15); display:flex; align-items:center; justify-content:center; margin-bottom:16px; color:var(--accent-emerald);">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
            </div>
            <h3 style="font-size:1.1rem; font-weight:600; margin-bottom:8px;">Tailored Artifacts</h3>
            <p style="color:var(--text-muted); font-size:0.875rem;">Generate evidence-grounded resumes, targeted cover letters, and portfolio recommendations with exact code citations.</p>
          </div>

          <div class="card">
            <div style="width:40px; height:40px; border-radius:10px; background:rgba(245,158,11,0.15); display:flex; align-items:center; justify-content:center; margin-bottom:16px; color:var(--accent-amber);">
            ...
            <h3 style="font-size:1.1rem; font-weight:600; margin-bottom:8px;">Application Tracker</h3>
            <p style="color:var(--text-muted); font-size:0.875rem;">Sovereign multi-stage job pipeline with interview logs and immutable point-in-time document snapshots.</p>
          </div>
          ...
          <div class="card">
            ...
            <h3 style="font-size:1.1rem; font-weight:600; margin-bottom:8px;">Two-Phase Write Safety</h3>
            <p style="color:var(--text-muted); font-size:0.875rem;">No AI can modify code directly. AI generates HMAC-signed approval tickets; human confirms before PR creation.</p>
          </div>
          ...
          <div class="card">
            ...
            <h3 style="font-size:1.1rem; font-weight:600; margin-bottom:8px;">Universal AI Access</h3>
            <p style="color:var(--text-muted); font-size:0.875rem;">Full Model Context Protocol (MCP) compatibility across Google Gemini, Anthropic Claude, and OpenAI ChatGPT.</p>
          </div>
        </div>
      </section>
      ...
      <section class="card" style="margin-bottom:64px; text-align:center; padding:36px;">
        ...
        <div style="display:flex; justify-content:center; align-items:center; gap:32px; flex-wrap:wrap;">
          <div style="display:flex; align-items:center; gap:10px; background:rgba(255,255,255,0.03); padding:10px 20px; border-radius:10px; border:1px solid var(--border-subtle);">
            ...
            <strong style="font-size:0.95rem;">Anthropic Claude</strong>
          ...
          <div style="display:flex; align-items:center; gap:10px; background:rgba(255,255,255,0.03); padding:10px 20px; border-radius:10px; border:1px solid var(--border-subtle);">
            ...
            <strong style="font-size:0.95rem;">OpenAI ChatGPT</strong>
            <span class="badge badge-verified">Custom GPT Action</span>
          </div>

          <div style="display:flex; align-items:center; gap:10px; background:rgba(255,255,255,0.03); padding:10px 20px; border-radius:10px; border:1px solid var(--border-subtle);">
            <div style="width:10px; height:10px; border-radius:50%; background:var(--accent-cyan);"></div>
            <strong style="font-size:0.95rem;">Google Gemini</strong>
      ...
      <section style="text-align:center; padding: 32px 0 48px;">
        <h2 style="font-size:1.8rem; font-weight:700; margin-bottom:12px;">Ready to ground your career narrative in real code?</h2>
        <p style="color:var(--text-muted); font-size:1rem; margin-bottom:28px;">Connect your repositories in 2 minutes with least-privilege permissions.</p>
        <a href="/login" class="btn btn-primary" style="padding:12px 32px; font-size:1rem;">
