...
function createSample({
  ...
  const compositeScores = [reviewer1.composite, reviewer2.composite, reviewer3.composite].sort(
    (a, b) => a - b
  );
...
const strongHires = [
  {
    ...
    domain: 'DIST_SYS',
    job: HOLDOUT_JOB_DIST_SYS,
    skills: ['Go', 'Distributed Systems', 'Raft', 'Kubernetes'],
    metric: '45% reduction in replication delay',
    mVal: '45%',
  },
  {
    id: 'holdout-02',
    title: 'Principal Consensus Architect',
    domain: 'DIST_SYS',
    job: HOLDOUT_JOB_DIST_SYS,
    skills: ['Go', 'Distributed Systems', 'Raft'],
    metric: 'handled 200k ops/sec cluster load',
    mVal: '200k ops/sec',
  },
  {
    id: 'holdout-03',
    ...
    job: HOLDOUT_JOB_DIST_SYS,
    skills: ['Go', 'Distributed Systems', 'Raft', 'Kubernetes'],
    metric: 'cut failover recovery time by 50%',
    mVal: '50%',
  },
  {
    id: 'holdout-04',
    ...
    domain: 'FRONTEND',
    job: HOLDOUT_JOB_FRONTEND,
    skills: ['React', 'TypeScript', 'Next.js', 'GraphQL'],
    metric: 'improved initial render time by 40%',
    mVal: '40%',
  },
  {
    id: 'holdout-05',
    title: 'Staff UI Infrastructure Lead',
    domain: 'FRONTEND',
    job: HOLDOUT_JOB_FRONTEND,
    skills: ['React', 'TypeScript', 'Next.js'],
    metric: 'decreased bundle size by 35%',
    mVal: '35%',
  },
  {
    id: 'holdout-06',
    ...
    job: HOLDOUT_JOB_FRONTEND,
    skills: ['React', 'TypeScript', 'Next.js', 'GraphQL'],
    metric: 'scaled client cache to 10M requests/day',
    mVal: '10M requests/day',
  },
  {
    id: 'holdout-07',
    title: 'Staff Data Platform Engineer',
    domain: 'DATA',
    job: HOLDOUT_JOB_DATA_PLATFORM,
    skills: ['Python', 'Spark', 'Kafka', 'SQL'],
    metric: 'processed 5TB daily pipeline volume',
    mVal: '5TB daily',
  },
  {
    id: 'holdout-08',
    title: 'Principal Streaming Architect',
    domain: 'DATA',
    job: HOLDOUT_JOB_DATA_PLATFORM,
    skills: ['Python', 'Spark', 'Kafka', 'SQL'],
    metric: 'lowered stream processing latency by 60%',
    mVal: '60%',
  },
  {
    id: 'holdout-09',
    title: 'Staff Application Security Architect',
    domain: 'SECURITY',
    job: HOLDOUT_JOB_SECURITY,
    skills: ['OAuth', 'Cryptography', 'AppSec', 'Go'],
    metric: 'automated 100% token rotation policy',
    mVal: '100%',
  },
  {
    id: 'holdout-10',
    ...
    domain: 'SECURITY',
    job: HOLDOUT_JOB_SECURITY,
    skills: ['OAuth', 'Cryptography', 'AppSec'],
    metric: 'secured zero-trust authentication boundary',
    mVal: null,
  },
];
...
const midHires = [
  {
    id: 'holdout-11',
    title: 'Mid-Level Distributed Systems Engineer',
    domain: 'DIST_SYS',
    job: HOLDOUT_JOB_DIST_SYS,
    skills: ['Go', 'Distributed Systems', 'Raft'],
  },
  ...
  {
    id: 'holdout-14',
    title: 'Mid-Level Web Applications Engineer',
    domain: 'FRONTEND',
    job: HOLDOUT_JOB_FRONTEND,
  ...
  {
    id: 'holdout-15',
    title: 'Mid-Level Data Pipeline Engineer',
    domain: 'DATA',
    job: HOLDOUT_JOB_DATA_PLATFORM,
  ...
  {
    id: 'holdout-16',
    title: 'Mid-Level Streaming Data Engineer',
    domain: 'DATA',
    job: HOLDOUT_JOB_DATA_PLATFORM,
  ...
  {
    id: 'holdout-17',
    title: 'Mid-Level AppSec Engineer',
    domain: 'SECURITY',
    job: HOLDOUT_JOB_SECURITY,
    skills: ['OAuth', 'AppSec'],
  },
  {
    id: 'holdout-18',
    title: 'Mid-Level Identity Engineer',
    domain: 'SECURITY',
    job: HOLDOUT_JOB_SECURITY,
    skills: ['OAuth', 'Cryptography'],
  },
];
...
midHires.forEach((m, i) => {
  samples.push(
    createSample({
      ...
      facts: [
        {
          text: `Built reliable microservices and modules in ${m.skills.join(', ')}`,
...
const juniorHires = [
  {
    id: 'holdout-19',
    title: 'Junior Distributed Systems Engineer',
    domain: 'DIST_SYS',
    job: HOLDOUT_JOB_DIST_SYS,
    skills: ['Go', 'Distributed Systems'],
  },
...
juniorHires.forEach((j, i) => {
  samples.push(
    createSample({
      ...
      facts: [
        {
          text: `Assisted in engineering projects and coursework with ${j.skills.join(', ')}`,
...
const formatChallenged = [
  {
    id: 'holdout-23',
    title: 'Lead Consensus Researcher',
    domain: 'DIST_SYS',
    job: HOLDOUT_JOB_DIST_SYS,
    skills: ['Go', 'Distributed Systems', 'Raft'],
  },
  ...
  {
    id: 'holdout-26',
    title: 'Lead Security Systems Architect',
    domain: 'SECURITY',
    job: HOLDOUT_JOB_SECURITY,
    skills: ['OAuth', 'Cryptography', 'AppSec'],
  },
...
formatChallenged.forEach((fc, i) => {
  ...
  samples.push(
    createSample({
      ...
      facts: [
        {
          text: `Architected high-scale platform components using ${fc.skills.join(', ')}`,
          technologies: fc.skills,
          provenanceStatus: 'VERIFIED',
          corroborated: true,
        },
      ],
...
const borderline = [
  {
    id: 'holdout-27',
    title: 'Backend Engineer Missing Raft',
    domain: 'DIST_SYS',
    job: HOLDOUT_JOB_DIST_SYS,
  ...
  {
    id: 'holdout-28',
    title: 'Frontend Developer Missing Next.js',
    domain: 'FRONTEND',
    job: HOLDOUT_JOB_FRONTEND,
  ...
  {
    id: 'holdout-29',
    title: 'Data Analyst Missing Spark & Kafka',
    domain: 'DATA',
    job: HOLDOUT_JOB_DATA_PLATFORM,
    skills: ['Python', 'SQL'],
  },
...
borderline.forEach((b, i) => {
  samples.push(
    createSample({
      ...
      facts: [
        {
          text: `Assisted in developing basic applications with ${b.skills.join(', ')}`,
...
const mismatches = [
  {
    id: 'holdout-30',
    title: 'Mobile iOS Dev applying to Distributed Systems',
    domain: 'DIST_SYS',
    job: HOLDOUT_JOB_DIST_SYS,
  ...
  {
    id: 'holdout-31',
    title: 'Frontend React Dev applying to Data Platform',
    domain: 'DATA',
    job: HOLDOUT_JOB_DATA_PLATFORM,
    skills: ['Vue', 'CSS'],
  },
  {
    id: 'holdout-32',
    title: 'Data Scientist applying to Security Infrastructure',
    domain: 'SECURITY',
    job: HOLDOUT_JOB_SECURITY,
    skills: ['R', 'Pandas'],
  },
  {
    id: 'holdout-33',
    title: 'Bootcamp Web Beginner applying to Staff Architect',
    domain: 'DIST_SYS',
    job: HOLDOUT_JOB_DIST_SYS,
    skills: ['HTML', 'CSS'],
  },
...
mismatches.forEach((m, i) => {
  samples.push(
    createSample({
      ...
      facts: [
        {
          text: `Built applications using ${m.skills.join(', ')}`,
          technologies: m.skills,
          provenanceStatus: 'VERIFIED',
          corroborated: true,
        },
...
const stuffed = [
  {
    id: 'holdout-34',
    title: 'Keyword Stuffed Distributed Systems',
    domain: 'DIST_SYS',
    job: HOLDOUT_JOB_DIST_SYS,
    skills: ['Go'],
  },
  {
    id: 'holdout-35',
    title: 'Keyword Stuffed Frontend UI',
    domain: 'FRONTEND',
    job: HOLDOUT_JOB_FRONTEND,
    skills: ['React'],
  },
...
stuffed.forEach((s, i) => {
  ...
  samples.push(
    createSample({
      ...
      facts: [
        {
          text: `Basic scripting in ${skillName}`,
...
const frauds = [
  {
    id: 'holdout-36',
    title: 'Fabricated 99.999% Availability Claim',
    domain: 'DIST_SYS',
    job: HOLDOUT_JOB_DIST_SYS,
    skills: ['Go'],
    fakeClaim: 'Engineered 99.999% zero-downtime consensus without source evidence',
  },
  {
    id: 'holdout-37',
    title: 'Fabricated $50M Cost Reduction Claim',
    domain: 'DATA',
    job: HOLDOUT_JOB_DATA_PLATFORM,
    skills: ['Python'],
    fakeClaim: 'Reduced cloud pipeline operational expense by $50M annually',
  },
  {
    id: 'holdout-38',
    title: 'Fabricated 95% Vulnerability Reduction',
    domain: 'SECURITY',
    job: HOLDOUT_JOB_SECURITY,
    skills: ['OAuth'],
    fakeClaim: 'Eliminated 95% of enterprise breach vectors across cloud nodes',
  },
];
