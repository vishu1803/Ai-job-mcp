...
export const CANONICAL_SKILLS = Object.freeze({
  ...
  'access-control': {
    ...
    name: 'Access Control',
    category: 'CONCEPT',
    description: 'Selective restriction of access to a place or other resource.',
    aliases: ['access-control', 'authorization-models', 'acl'],
    relationships: {
      builtOn: [],
      ecosystemOf: ['security'],
      implements: ['application-security'],
      parentOf: ['rbac', 'abac', 'rebac'],
    },
  },
  rbac: {
    slug: 'rbac',
    ...
    category: 'CONCEPT',
    description: 'Policy-neutral access control mechanism defined around roles and privileges.',
    aliases: ['rbac', 'role-based-access-control', 'role-based-access'],
    relationships: {
      builtOn: [],
      ecosystemOf: ['security'],
  ...
  ldap: {
    ...
    name: 'LDAP',
    category: 'TOOL',
    description: 'Lightweight Directory Access Protocol for directory service authentication.',
    aliases: ['ldap', 'openldap', 'lightweight-directory-access-protocol'],
    relationships: {
      builtOn: [],
      ecosystemOf: ['security'],
      implements: ['access-control'],
  ...
  'active-directory': {
    ...
    category: 'TOOL',
    description: 'Directory service developed by Microsoft for Windows domain networks.',
    aliases: ['active-directory', 'active directory', 'ad', 'azure-ad', 'entra-id'],
    relationships: {
      builtOn: [],
      ecosystemOf: ['security'],
      implements: ['access-control'],
  ...
  'identity-federation': {
    ...
    aliases: ['identity-federation', 'federated-identity'],
    relationships: {
      builtOn: [],
      ecosystemOf: [],
      implements: ['authorization'],
      parentOf: ['sso', 'saml', 'openid-connect', 'scim'],
    },
  },
  cybersecurity: {
    slug: 'cybersecurity',
  ...
  // ===========================================================================
  // Security, Identity & Access Control — NEW additions (CONCEPT)
  ...
  'abac': {
    ...
    name: 'ABAC',
    category: 'CONCEPT',
    description: 'Attribute-Based Access Control — authorization model using attribute policies.',
    aliases: ['abac', 'attribute-based-access-control', 'attribute-based-access'],
    relationships: {
      builtOn: [],
      ecosystemOf: ['security'],
      implements: ['access-control'],
  ...
  'openid-connect': {
    ...
    aliases: ['openid-connect', 'oidc', 'openid', 'open-id-connect'],
    relationships: {
      builtOn: ['oauth'],
      ecosystemOf: ['security'],
  ...
  'saml': {
    ...
    name: 'SAML',
    category: 'CONCEPT',
    description: 'Security Assertion Markup Language — XML-based federated identity standard.',
    aliases: ['saml', 'saml-2.0', 'saml2', 'security-assertion-markup-language'],
    relationships: {
      builtOn: [],
      ecosystemOf: ['security'],
      implements: ['identity-federation'],
  ...
  'jwt': {
    ...
    aliases: ['jwt', 'json-web-token', 'json-web-tokens', 'jws', 'jwe'],
    relationships: {
      builtOn: [],
      ecosystemOf: ['oauth'],
      implements: [],
  ...
  xml: {
    ...
    name: 'XML',
    category: 'TOOL',
    description: 'Extensible Markup Language format for encoding documents.',
    aliases: ['xml'],
    relationships: {
      builtOn: [],
      ecosystemOf: [],
  ...
  communication: {
    ...
    name: 'Communication',
    category: 'CONCEPT',
    description: 'Effective written, verbal, and cross-functional technical communication.',
    aliases: ['communication', 'communication-skills', 'collaborative-communication'],
    relationships: {
      builtOn: [],
      ecosystemOf: [],
      implements: [],
