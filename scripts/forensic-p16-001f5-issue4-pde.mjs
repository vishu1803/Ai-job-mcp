...
const r = (
  ...
  SELECT profile_metadata::text AS t FROM candidates WHERE id='10a2b51b-09bf-4090-8040-1f60ebeb89c9'`)
).rows[0];
const t = r.t || '';
console.log(
  'has TypeORM bullet:',
  t.includes('Implemented PostgreSQL data persistence via TypeORM')
);
