...
const r1 = (
  ...
  WHERE profile_metadata::text LIKE '%Built a responsive Next.js 14 React frontend%'
    AND id = '10a2b51b-09bf-4090-8040-1f60ebeb89c9'`)
).rows[0];
...
const r2 = (
  ...
  WHERE metadata::text LIKE '%Built a responsive Next.js 14 React frontend%'
    AND candidate_id = '10a2b51b-09bf-4090-8040-1f60ebeb89c9'`)
).rows[0];
...
console.log(
  'latest package markdown has Next.js bullet:',
  (pkg.md || '').includes('Built a responsive Next.js 14 React frontend')
);
