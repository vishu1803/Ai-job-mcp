...
const stored = (
  ...
  WHERE candidate_id = '10a2b51b-09bf-4090-8040-1f60ebeb89c9'`)
).rows;
...
const cand = (
  ...
  WHERE id='10a2b51b-09bf-4090-8040-1f60ebeb89c9'`)
).rows[0];
...
const rec = reconcileCandidateProjects({
  profileProjects: profile,
  resumeDataProjects: cand.rd,
