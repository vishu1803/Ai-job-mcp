/**
 * @file Unit Tests for MCP Server Foundation & Security Layer (P7-001)
 *
 * Validates:
 * 1. McpServer factory initialization and metadata.
 ...
 * 9. Server lifecycle (connect/close).
 */
...
describe('MCP Server Foundation Unit Tests (P7-001)', () => {
  // ===========================================================================
  // 1. Server Factory & Metadata Initialization
  // ===========================================================================
  it('1. initializes McpServerWrapper with correct default name and version', () => {
  ...
  it('2. supports custom name and version overrides in factory', () => {
    const server = createMcpServer({ name: 'custom-career-mcp', version: '2.0.0' });
  ...
  // ===========================================================================
  it('3. registers a valid tool definition with input schema and handler', () => {
    const server = createMcpServer();
  ...
  it('4. rejects duplicate tool registration with clear error', () => {
    const server = createMcpServer();
    const toolDef = {
      name: 'duplicate_tool',
  ...
  it('5. rejects invalid tool names (e.g. spaces, uppercase, symbols)', () => {
    const server = createMcpServer();
  ...
  // ===========================================================================
  // 3. RBAC & Scope Permissions Assertion
  // ===========================================================================
  it('6. assertToolPermission permits READONLY user for READONLY tool', () => {
    const context = {
  ...
  it('7. assertToolPermission denies READONLY user attempting to invoke MEMBER or OWNER tool', () => {
    const context = {
      userId: '11111111-1111-1111-1111-111111111111',
      tenantId: '22222222-2222-2222-2222-222222222222',
      role: 'READONLY',
  ...
  it('8. assertToolPermission permits MEMBER user for MEMBER and READONLY tools but denies OWNER tool', () => {
    const context = {
      userId: '11111111-1111-1111-1111-111111111111',
      tenantId: '22222222-2222-2222-2222-222222222222',
      role: 'MEMBER',
  ...
  it('9. assertToolPermission permits OWNER for any tool with matching scope', () => {
    const context = {
      userId: '11111111-1111-1111-1111-111111111111',
      tenantId: '22222222-2222-2222-2222-222222222222',
      role: 'OWNER',
  ...
  it('10. assertToolPermission denies invocation if required token scope is missing', () => {
    const context = {
      userId: '11111111-1111-1111-1111-111111111111',
      tenantId: '22222222-2222-2222-2222-222222222222',
      role: 'OWNER',
  ...
  // ===========================================================================
  // 4. Bearer Token Extraction & Hashing
  // ===========================================================================
  it('11. extractBearerToken extracts token from standard Bearer header', () => {
  ...
  it('12. extractBearerToken throws AuthenticationError on missing or malformed header', () => {
  ...
  it('13. hashMcpToken computes SHA-256 hex hash deterministically', () => {
  ...
  // ===========================================================================
  // 5. McpRequestContext Schema Validation & Immutability
  // ===========================================================================
  it('14. McpRequestContextSchema validates well-formed security context', () => {
    const rawContext = {
  ...
  it('15. McpRequestContextSchema rejects invalid UUIDs or unknown roles', () => {
    const invalidContext = {
      requestId: 'not-a-uuid',
      tenantId: 'invalid-tenant',
      userId: 'invalid-user',
      role: 'SUPERADMIN', // Illegal role
    };
  ...
  // ===========================================================================
  // 6. Safe Error Mapping & Information-Leak Prevention
  // ===========================================================================
  it('16. mapErrorToMcpResponse maps AuthenticationError to -32001', () => {
  ...
  it('17. mapErrorToMcpResponse maps AuthorizationError to -32003', () => {
  ...
  it('18. mapErrorToMcpResponse maps NotFoundError to -32004 with generic message', () => {
  ...
  it('19. mapErrorToMcpResponse maps ValidationError to -32602 with details', () => {
  ...
  it('20. mapErrorToMcpResponse maps ConflictError to -32009', () => {
  ...
  it('21. mapErrorToMcpResponse maps RateLimitError to -32029', () => {
  ...
  it('22. mapErrorToMcpResponse sanitizes unexpected Error to -32603 without leaking SQL or stack traces', () => {
    ...
    // Ensure no SQL or internal file paths leak
  ...
  // ===========================================================================
  // 7. Server Lifecycle & Connection Cleanup
  // ===========================================================================
  it('23. start() and close() manage Streamable HTTP transport lifecycle cleanly', async () => {
    const server = createMcpServer();
    assert.strictEqual(server.isStarted, false);
    ...
    // Calling start again returns same active transport
    const transport2 = await server.start();
    assert.strictEqual(transport, transport2);
