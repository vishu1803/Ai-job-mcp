    ...
    projects: [
      {
        ...
        bullets: [
          ...
          'Engineered WebSocket event dispatcher for concurrent message handling.',
          'Integrated distributed pub-sub channels ensuring low-latency delivery.',
        ],
      },
      {
        id: 'p2',
        ...
        bullets: [
          'Optimized indexing queries for telemetry.',
          'Implemented table partitioning strategies for large-scale time-series records.',
          'Configured connection pool parameters to minimize connection spikes.',
        ],
      },
      {
        id: 'p3',
        ...
        bullets: [
          'Implemented responsive client portal.',
          'Designed modular component state architecture across user dashboard views.',
          'Integrated strict type definitions for client-server API contracts.',
        ],
      },
      {
        id: 'p4',
        ...
        bullets: [
          'Created worker queue for background jobs.',
          'Engineered asynchronous task retry scheduler with exponential backoff.',
          'Instrumented job processing metrics and error tracking telemetry.',
        ],
      },
      {
        id: 'p5',
        ...
        technologies: ['Docker'],
        bullets: [
          'Automated container builds in CI.',
          'Created multi-stage Dockerfiles reducing production image footprints.',
          'Standardized local development environments across engineering teams.',
        ],
      },
    ],
    experience: [],
      ...
      projects: [
        {
          ...
          technologies: ['Go'],
          bullets: [
            'Built HTTP reverse proxy gateway.',
            'Engineered concurrent request routing with zero-copy buffer pooling.',
            'Integrated rate limiting and health check probes for upstream services.',
          ],
        },
      ],
