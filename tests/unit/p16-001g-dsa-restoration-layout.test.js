  ...
  projects: [
    {
      ...
      bullets: [
        'Built CSV ingestion pipeline with streaming validation.',
        'Architected relational PostgreSQL data store with optimized indexing.',
        'Designed interactive analytics dashboard rendering responsive metric views.',
      ],
    ...
    },
    {
      ...
      bullets: [
        'Implemented live task synchronization across clients using WebSockets.',
        'Developed state management layer ensuring deterministic state reconciliation.',
        'Integrated role-based permissions across project workspace boards.',
      ],
